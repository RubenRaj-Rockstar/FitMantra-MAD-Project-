...
import 'package:fitmantra/common_widget/icon_title_next_row.dart';
import 'package:fitmantra/common_widget/round_button.dart';
import 'package:fitmantra/view/workout_tracker/exercises_stpe_details.dart';
import 'package:fitmantra/view/workout_tracker/workout_schedule_view.dart';
...
class _WorkoutDetailViewState extends State<WorkoutDetailView> {
   String _selectedOption = "Beginner"; // Default selection
  bool _isDropdownVisible = false; // To toggle dropdown visibility
  List latestArr = [
    {
  ...
  Widget build(BuildContext context) {
                      ...
                      Column(
                        ...
                        children: [
                          IconTitleNextRow(
                              ...
                              title: "Difficulity",
                              time:  _selectedOption, // Show the currently selected option
    ...
    if (_isDropdownVisible) // Conditionally show the dropdown
      Container(
        ...
        child: Column(
          children: [
            ListTile(
              ...
              onTap: () {
                setState(() {
                  _selectedOption = "Beginner"; // Update selection
            ...
            ListTile(
              ...
              onTap: () {
                setState(() {
                  _selectedOption = "Advanced"; // Update selection
                  _isDropdownVisible = false; // Hide dropdown
                });
              },
            ),
